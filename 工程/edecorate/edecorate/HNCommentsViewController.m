...
- (void)viewDidLoad
{
    ...
    //add UItableView
    self.tableView=[[UITableView alloc]initWithFrame:CGRectMake(0, 90, self.view.frame.size.width, self.view.frame.size.height-108-90) style:UITableViewStylePlain];

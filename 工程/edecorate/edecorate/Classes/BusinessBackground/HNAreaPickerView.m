...
@implementation HNAreaPickerView
...
- (id)initWithStyle:(HNAreaPickerStyle)pickerStyle delegate:(id<HNAreaPickerDelegate>)delegate
{
    ...
    self = [[[NSBundle mainBundle] loadNibNamed:@"HNAreaPickerView" owner:self options:nil] objectAtIndex:0];
    if (self) {
